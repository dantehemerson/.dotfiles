...
echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDemo mock_key 18385321+dantehemerson@users.noreply.github.com" > "${KEYFILE}.pub"
EOF
...
test_public_key_contains_email() {
  ...
  assert_contains "$pub_key_content" "18385321+dantehemerson@users.noreply.github.com" "Public key should contain the email"
}
